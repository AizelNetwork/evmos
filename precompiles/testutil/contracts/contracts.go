...
func Call(ctx sdk.Context, app *aizelapp.Aizel, args CallArgs) (res abci.ExecTxResult, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
	...
	res, err = aizelutil.DeliverEthTx(app, args.PrivKey, msg)
	if err != nil {
...
func CallContractAndCheckLogs(ctx sdk.Context, app *aizelapp.Aizel, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ExecTxResult, *evmtypes.MsgEthereumTxResponse, error) {
