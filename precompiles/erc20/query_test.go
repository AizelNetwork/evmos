...
var (
	...
	validAttoTraceDenom = types.DenomTrace{Path: "channel-0", BaseDenom: "aaizel"}
	// validTraceDenomNoMicroAtto is a denomination trace with a valid IBC voucher name but no micro or atto prefix
	validTraceDenomNoMicroAtto = types.DenomTrace{Path: "channel-0", BaseDenom: "maizel"}
...
func (s *PrecompileTestSuite) TestNameSymbol() {
	...
	testcases := []struct {
		name        string
		denom       string
		malleate    func(sdk.Context, *app.Aizel)
		expPass     bool
		errContains string
		expName     string
		expSymbol   string
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Aizel) {
...
func (s *PrecompileTestSuite) TestTotalSupply() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Aizel, *big.Int)
		expPass     bool
		errContains string
		expTotal    *big.Int
	}{
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Aizel, amount *big.Int) {
				// NOTE: we mint some coins to the inflation module address to be able to set denom metadata
...
func (s *PrecompileTestSuite) TestBalanceOf() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Aizel, *big.Int) []interface{}
		expPass     bool
		errContains string
		expBalance  *big.Int
	}{
		{
			...
			malleate: func(_ sdk.Context, _ *app.Aizel, _ *big.Int) []interface{} {
				return []interface{}{}
			},
		...
		{
			name: "pass - some coins",
			malleate: func(ctx sdk.Context, app *app.Aizel, amount *big.Int) []interface{} {
...
func (s *PrecompileTestSuite) TestAllowance() {
	...
	testcases := []struct {
		...
		},
		{
			...
			malleate: func(_ sdk.Context, _ *app.Aizel, amount *big.Int) []interface{} {
				granterIdx := 0
				granteeIdx := 1
