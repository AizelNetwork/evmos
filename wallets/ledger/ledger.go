...
func AizelLedgerDerivation() Secp256k1DerivationFn {
	aizelSECP256K1 := new(AizelSECP256K1)
...
var _ sdkledger.SECP256K1 = &AizelSECP256K1{}

// AizelSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type AizelSECP256K1 struct {
	*usbwallet.Hub
...
func (e AizelSECP256K1) Close() error {
...
func (e AizelSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
func (e AizelSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e AizelSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e AizelSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *AizelSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
