...
Aizel Non-Commercial License 1.0 (ENCL-1.0) was created by Tharsis Labs Ltd.
(Aizel) to provide a mutually beneficial balance between the user benefits of
...
**Q: What is Aizel Non-Commercial License 1.0 (ENCL-1.0)?**
...
blockchain consensus. The initial Designated Blockchains shall be the Aizel
blockchains, identified by chain identifiers 9000 (testing network or testnet)
and 9001 (main network or mainnet).

Aizel is currently building evmOS, the commercial name of the software associated with the Aizel repository,
...
For more information about evmOS, check out the Aizel Manifesto.
...
open source, such as empowering all non-Aizel software developers to be part of
...
**A:** You may contact the legal department of licensor: os@aizel.org. They
...
**Q: What if I am currently using Aizel code commercially in my business/project?**

**A:**You are allowed to continue using the code from older versions (<v13.0.0)
of Aizel repository under LGPL 3.0, however, you must obtain a commercial permit
...
"Required Notice: Copyright Tharsis Labs Ltd. (Aizel)(https://github.com/AizelNetwork)"
...
Aizel does not claim it to be one. The legal phrasing of the ENCL 1.0 has been
...
For more information on the evmOS, check out the Aizel Manifesto.
...
permit from Aizel for the ENCL code, but we will not grant rights to release the
...
**A:** First, a big thank you! You can contribute the code to the official Aizel
