...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "aizel_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid eip155 chain-id, cannot start with 0", "aizel_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "aizel_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "aizel_aizel_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "aizel_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "aizel_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
