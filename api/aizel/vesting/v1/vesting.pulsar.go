...
func init() {
	file_aizel_vesting_v1_vesting_proto_init()
	md_ClawbackVestingAccount = File_aizel_vesting_v1_vesting_proto.Messages().ByName("ClawbackVestingAccount")
...
func (x *ClawbackVestingAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_aizel_vesting_v1_vesting_proto_msgTypes[0]
...
func (x *fastReflection_ClawbackVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "aizel.vesting.v1.ClawbackVestingAccount.base_vesting_account":
		return x.BaseVestingAccount != nil
	case "aizel.vesting.v1.ClawbackVestingAccount.funder_address":
		return x.FunderAddress != ""
	case "aizel.vesting.v1.ClawbackVestingAccount.start_time":
		return x.StartTime != nil
	case "aizel.vesting.v1.ClawbackVestingAccount.lockup_periods":
		return len(x.LockupPeriods) != 0
	case "aizel.vesting.v1.ClawbackVestingAccount.vesting_periods":
		return len(x.VestingPeriods) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: aizel.vesting.v1.ClawbackVestingAccount"))
		}
		panic(fmt.Errorf("message aizel.vesting.v1.ClawbackVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message aizel.vesting.v1.ClawbackVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "aizel.vesting.v1.ClawbackVestingAccount.vesting_periods":
		...
		return protoreflect.ValueOfList(value)
	case "aizel.vesting.v1.ClawbackVestingAccount.funder_address":
		panic(fmt.Errorf("field funder_address of message aizel.vesting.v1.ClawbackVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: aizel.vesting.v1.ClawbackVestingAccount"))
		}
...
func (x *fastReflection_ClawbackVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in aizel.vesting.v1.ClawbackVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: aizel/vesting/v1/vesting.proto
...
func (*ClawbackVestingAccount) Descriptor() ([]byte, []int) {
	return file_aizel_vesting_v1_vesting_proto_rawDescGZIP(), []int{0}
}
...
var File_aizel_vesting_v1_vesting_proto protoreflect.FileDescriptor

var file_aizel_vesting_v1_vesting_proto_rawDesc = []byte{
	...
	0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x69, 0x7a, 0x65, 0x6c, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69,
	...
	,
}

var (
	file_aizel_vesting_v1_vesting_proto_rawDescOnce sync.Once
	file_aizel_vesting_v1_vesting_proto_rawDescData = file_aizel_vesting_v1_vesting_proto_rawDesc
)

func file_aizel_vesting_v1_vesting_proto_rawDescGZIP() []byte {
	file_aizel_vesting_v1_vesting_proto_rawDescOnce.Do(func() {
		file_aizel_vesting_v1_vesting_proto_rawDescData = protoimpl.X.CompressGZIP(file_aizel_vesting_v1_vesting_proto_rawDescData)
	})
	return file_aizel_vesting_v1_vesting_proto_rawDescData
}

var file_aizel_vesting_v1_vesting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_aizel_vesting_v1_vesting_proto_goTypes = []interface{}{
	(*ClawbackVestingAccount)(nil),     // 0: aizel.vesting.v1.ClawbackVestingAccount
...
var file_aizel_vesting_v1_vesting_proto_depIdxs = []int32{
	1, // 0: aizel.vesting.v1.ClawbackVestingAccount.base_vesting_account:type_name -> cosmos.vesting.v1beta1.BaseVestingAccount
	2, // 1: aizel.vesting.v1.ClawbackVestingAccount.start_time:type_name -> google.protobuf.Timestamp
	3, // 2: aizel.vesting.v1.ClawbackVestingAccount.lockup_periods:type_name -> cosmos.vesting.v1beta1.Period
	3, // 3: aizel.vesting.v1.ClawbackVestingAccount.vesting_periods:type_name -> cosmos.vesting.v1beta1.Period
...
func init() { file_aizel_vesting_v1_vesting_proto_init() }
func file_aizel_vesting_v1_vesting_proto_init() {
	if File_aizel_vesting_v1_vesting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_aizel_vesting_v1_vesting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_aizel_vesting_v1_vesting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_aizel_vesting_v1_vesting_proto_goTypes,
		DependencyIndexes: file_aizel_vesting_v1_vesting_proto_depIdxs,
		MessageInfos:      file_aizel_vesting_v1_vesting_proto_msgTypes,
	}.Build()
	File_aizel_vesting_v1_vesting_proto = out.File
	file_aizel_vesting_v1_vesting_proto_rawDesc = nil
	file_aizel_vesting_v1_vesting_proto_goTypes = nil
	file_aizel_vesting_v1_vesting_proto_depIdxs = nil
}
