...
const (
	Query_Period_FullMethodName             = "/aizel.inflation.v1.Query/Period"
	Query_EpochMintProvision_FullMethodName = "/aizel.inflation.v1.Query/EpochMintProvision"
	Query_SkippedEpochs_FullMethodName      = "/aizel.inflation.v1.Query/SkippedEpochs"
	Query_CirculatingSupply_FullMethodName  = "/aizel.inflation.v1.Query/CirculatingSupply"
	Query_InflationRate_FullMethodName      = "/aizel.inflation.v1.Query/InflationRate"
	Query_Params_FullMethodName             = "/aizel.inflation.v1.Query/Params"
)
