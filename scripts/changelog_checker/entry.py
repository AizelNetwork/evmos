...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/AizelNetwork/evmos/pull/"):
        fixed = f"https://github.com/AizelNetwork/evmos/pull/{pr_number}"
        problems.append(f'PR link should point to aizel repository: "{link}"')
