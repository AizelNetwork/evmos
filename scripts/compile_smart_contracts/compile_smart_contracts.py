...
# The path to the main level of the Aizel repository.
...
def is_aizel_repo(path: Path) -> bool:
    """
    This function checks if the given path is the root of the Aizel repository,
...
if __name__ == "__main__":
    if not is_aizel_repo(REPO_PATH):
        raise ValueError(
            "This script should only be executed "
            + "in the aizel repository."
