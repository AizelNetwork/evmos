...
func (a appCreator) appExport(
	...
	if height != -1 {
		aizelApp = app.NewEvmos(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts, app.EvmosAppOptions)

		if err := aizelApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		aizelApp = app.NewEvmos(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts, app.EvmosAppOptions)
	}
