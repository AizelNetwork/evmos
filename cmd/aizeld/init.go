...
func InitCmd(mbm module.BasicManager, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			default:
				chainID = fmt.Sprintf("aizel_9000-%v", cmtrand.Str(6))
			}
	...
	cmd.Flags().String(genutilcli.FlagDefaultBondDenom, aizeltypes.BaseDenom, "defines the default denom to use in genesis file")
