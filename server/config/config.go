...
import (
	...
	_ "github.com/AizelNetwork/evmos/v20/server/config/migration" // Add this import to set up the proper app.toml migration logic for sdk v0.50
)
...
const (
	...
	DefaultRosettaDenomToSuggest = "aaizel"
...
func AppConfig(denom string) (string, interface{}) {
	...
	//
	// In aizel, we set the min gas prices to 0.
	if denom != "" {
