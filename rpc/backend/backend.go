...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*aizeltypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*aizeltypes.TxResult, error)
...
type Backend struct {
	...
	indexer             aizeltypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := aizeltypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
