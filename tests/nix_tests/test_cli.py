...
def test_block_cmd(aizel_cluster):
    """
    - start 2 aizel nodes
    ...
    node1 = aizel_cluster.cosmos_cli(1)
...
def test_tx_flags(aizel_cluster):
    ...
    for tc in test_cases:
        try:
            res = node.transfer(
                "signer1",
                "aizel10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
