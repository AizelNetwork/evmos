...
def test_block(aizel_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on aizel and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(aizel_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(aizel_cluster, geth, True)


def get_blocks(aizel_rpc_ws, geth, with_transactions):
    w3: Web3 = aizel_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    aizel_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [aizel_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(aizel_cluster, geth):
...
def test_syncing(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(aizel_cluster, geth):
    # on aizel the proof query will fail for block numbers <= 2
...
def test_get_code(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(aizel_cluster, geth):
    w3: Web3 = aizel_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(aizel_cluster, geth):
...
def test_incomplete_send_transaction(aizel_cluster, geth):
