...
func TestGetCirculatingSupplyAndInflationRate(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			sdk.TokensFromConsensusPower(400_000_000, aizeltypes.PowerReduction),
			func() {
		...
		{
			"high supply",
			sdk.TokensFromConsensusPower(800_000_000, aizeltypes.PowerReduction),
			func() {},
		},
		{
			"low supply",
		...
		},
		{
			...
			sdk.TokensFromConsensusPower(200_000_000, aizeltypes.PowerReduction),
			func() {},
		},
	}
