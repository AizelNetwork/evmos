...
import (
	...
	aizelcore "github.com/AizelNetwork/evmos/v20/x/evm/core/core"
...
// RANDAO implementation. See https://github.com/aizel/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: aizelcore.CanTransfer,
		Transfer:    aizelcore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    aizeltypes.BlockGasLimit(ctx),
	...
	txCtx := aizelcore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := aizeltypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	// for more info https://github.com/aizel/ethermint/issues/1085
