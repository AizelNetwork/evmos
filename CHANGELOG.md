...
- (precompiles) [#2943](https://github.com/AizelNetwork/evmos/pull/2943) Add WERC-20 precompile.
...
- (app) [#3009](https://github.com/AizelNetwork/evmos/pull/3009) Move internal Evmos app initialization to input function.
...
## [v19.2.1](https://github.com/AizelNetwork/evmos/releases/tag/v19.2.1) - 2024-09-27
...
- (deps) [#2355](https://github.com/AizelNetwork/evmos/pull/2355) Bump Cosmos-SDK to v0.47.8-evmos.
...
- (precompiles) [#2529](https://github.com/AizelNetwork/evmos/pull/2529) Remove Outposts precompiles.
...
- (tests) [#2280](https://github.com/AizelNetwork/evmos/pull/2280) Enable specifying the prefunded balances for the integration test setup.
...
- (docs) [#2478](https://github.com/AizelNetwork/evmos/pull/2478) Change Evmos SDK with evmOS.
...
- (evm) [#2663](https://github.com/AizelNetwork/evmos/pull/2663) Port Geth `core/vm` into Evmos `x/evm`.
...
- (evm) [#2672](https://github.com/AizelNetwork/evmos/pull/2672) Add setter for custom operations in the EVM.
...
## [v17.0.0](https://github.com/AizelNetwork/evmos/releases/tag/v17.0.0) - 2024-04-08
...
- (incentives) [#2070](https://github.com/AizelNetwork/evmos/pull/2070) Remove `x/incentives` module and burn incentives pool balance.
...
- (osmosis-outpost) [#1986](https://github.com/AizelNetwork/evmos/pull/1986) Add Osmosis outpost transaction.
...
- (osmosis-outpost) [#2063](https://github.com/AizelNetwork/evmos/pull/2063) Check that receiver address is bech32 with "evmos" as human readable part.
...
- (app) [#1835](https://github.com/AizelNetwork/evmos/pull/1835) Remove migration logic from the app's `BeginBlocker`.
...
- (proto) [#1684](https://github.com/AizelNetwork/evmos/pull/1684) Update proto files to use `evmos/v14`.
- (deps) [#1682](https://github.com/AizelNetwork/evmos/pull/1682) Migrate `evmos-ledger-go` logic to this repository.
- (cli) [#1677](https://github.com/AizelNetwork/evmos/pull/1677) Update docs for `vesting` CLI.
- (go) [#1674](https://github.com/AizelNetwork/evmos/pull/1674) Update `evmos` module name to `evmos/v14`.
...
## [v13.0.2](https://github.com/AizelNetwork/evmos/releases/tag/v13.0.2) - 2023-07-05

### Bug Fixes

- (upgrade) [#1644](https://github.com/AizelNetwork/evmos/pull/1644) Adjust upgrade constants.
- (ci) [#1642](https://github.com/AizelNetwork/evmos/pull/1642) Fix target folder in GH action to push to the [Buf Schema Registry](https://buf.build/evmos/evmos) upon release.
...
- (deps) [#1492](https://github.com/AizelNetwork/evmos/pull/1492) Bump Cosmos SDK version to [`v0.46.11-alpha.ledger`](https://github.com/evmos/cosmos-sdk/releases/tag/v0.46.11-alpha.ledger) & use cometbft [`v0.34.27`](https://github.com/cometbft/cometbft/releases/tag/v0.34.27) replacement for Tendermint import.
...
- (evm) [#1602](https://github.com/AizelNetwork/evmos/pull/1602) Fixed hard coded BaseDenom and wrong comparison for MaxUint256.
...
- (ci) [#1475](https://github.com/AizelNetwork/evmos/pull/1475) Fix version of GitHub action to push to the [Buf Schema Registry](https://buf.build/evmos/evmos) upon releases.
...
## [v12.1.2](https://github.com/AizelNetwork/evmos/releases/tag/v12.1.2) - 2023-04-14
...
- (deps) [#1498](https://github.com/AizelNetwork/evmos/pull/1498) Bump Cosmos-SDK version to [v0.46.10-ledger.1](https://github.com/evmos/Cosmos-SDK/releases/tag/v0.46.10-ledger.1).
...
- (erc20) [#1306](https://github.com/AizelNetwork/evmos/pull/1306) Migrate `contracts` directory to evmos repository.
...
- (tests) [#1434](https://github.com/AizelNetwork/evmos/pull/1434) Set default staking denom to `aevmos` in `evm` and `feemarket` tests.
...
- (deps) [#1370](https://github.com/AizelNetwork/evmos/pull/1370) Bump Cosmos-SDK to [`v0.46.9-ledger`](https://github.com/evmos/Cosmos-SDK/releases/tag/v0.46.9-ledger) and Tendermint to [`v0.34.26`](https://github.com/informalsystems/tendermint/releases/tag/v0.34.26).
...
- (evm) [#1349](https://github.com/AizelNetwork/evmos/pull/1349) Restrict the Evmos codebase from working with chain IDs other than `9000` and `9001`.
...
- (deps) [#1473](https://github.com/AizelNetwork/evmos/pull/1473) Bump Cosmos-SDK version to [v0.46.10-alpha.ledger.2](https://github.com/evmos/Cosmos-SDK/releases/tag/v0.46.10-alpha.ledger.2).
...
- (deps) [#1288](https://github.com/AizelNetwork/evmos/pull/1288) Bump `ethermint` to [`v0.21.0`](https://github.com/evmos/ethermint/releases/v0.21.0).
...
- (incentives) [#1130](https://github.com/AizelNetwork/evmos/pull/1130) Deprecate usage of `x/params` in `x/incentives`.
...
- (deps) [#1279](https://github.com/AizelNetwork/evmos/pull/1279) Bump Cosmos-SDK version to [`v0.46.8-ledger`](https://github.com/evmos/Cosmos-SDK/releases/tag/v0.46.8-ledger).
...
- (deps) [#1184](https://github.com/AizelNetwork/evmos/pull/1184) Bump Ethermint version to [`v0.20.0-rc5`](https://github.com/evmos/ethermint/releases/tag/v0.20.0-rc5).
...
- (deps) [#875](https://github.com/AizelNetwork/evmos/pull/875) Bump Ethermint version to [`v0.19.2`](https://github.com/evmos/ethermint/releases/tag/v0.19.2).

## [v8.0.0](https://github.com/AizelNetwork/evmos/releases/tag/v8.0.0) - 2022-08-16

### State Machine Breaking

- (deps) [#845](https://github.com/AizelNetwork/evmos/pull/845) Bump Ethermint version to [`v0.19.0`](https://github.com/evmos/ethermint/releases/tag/v0.19.0).
...
- (deps) [#825](https://github.com/AizelNetwork/evmos/pull/825) Bump Ethermint version to [`v0.18.0`](https://github.com/evmos/ethermint/releases/tag/v0.18.0).
...
- (deps) [#803](https://github.com/AizelNetwork/evmos/pull/803) Bump Ethermint version to [`v0.17.2`](https://github.com/evmos/ethermint/releases/tag/v0.17.2).

## [v6.0.2](https://github.com/AizelNetwork/evmos/releases/tag/v6.0.2) - 2022-07-13

### Bug Fixes

- (deps) [#769](https://github.com/AizelNetwork/evmos/pull/769) Bump Ethermint version to [`v0.17.1`](https://github.com/evmos/ethermint/releases/tag/v0.17.1).
...
- (deps) [#719](https://github.com/AizelNetwork/evmos/pull/719) Bump Ethermint version to [`v0.17.0`](https://github.com/evmos/ethermint/releases/tag/v0.17.0).
...
- (deps) [#663](https://github.com/AizelNetwork/evmos/pull/663) Bump Ethermint version to [`v0.16.1`](https://github.com/evmos/ethermint/releases/tag/v0.16.1).
...
- (metrics) [#637](https://github.com/AizelNetwork/evmos/pull/637) Add telemetry to Evmos modules.
...
- (upgrade) [#557](https://github.com/AizelNetwork/evmos/pull/557) Update Evmos go.mod version `v3` -> `v4`.
...
- (inflation) [#536](https://github.com/AizelNetwork/evmos/pull/536) Rename inflation endpoint `/evmos/inflation/v1/total_supply` -> `/evmos/inflation/v1/circulating_supply`.

### Improvements

- (deps) [#580](https://github.com/AizelNetwork/evmos/pull/580) Bump Ethermint to [`v0.15.0`](https://github.com/evmos/ethermint/releases/tag/v0.15.0).
...
- (cli) [#543](https://github.com/AizelNetwork/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025aevmos`.
...
- (go) [#415](https://github.com/AizelNetwork/evmos/pull/415) Bump Evmos go version to v3.

### Bug Fixes

- (vesting) [#502](https://github.com/AizelNetwork/evmos/pull/502) Fix gas exhaustion bug by removing `SpendableCoins` during vesting account clawback.
...
- (deps) [#478](https://github.com/AizelNetwork/evmos/pull/478) Bump Cosmos-SDK to [`v0.45.3`](https://github.com/cosmos/Cosmos-SDK/releases/tag/v0.45.3) and Ethermint to [`v0.14.0`](https://github.com/evmos/ethermint/releases/tag/v0.14.0).
- (vesting) [#468](https://github.com/AizelNetwork/evmos/pull/468) Use coins `Min` function from Cosmos-SDK.
- (cli) [#446](https://github.com/AizelNetwork/evmos/pull/446) Update `migrate` command to migrate Evmos, Ethermint and Cosmos-SDK modules and upgrade code refactors.
...
## [v2.0.0](https://github.com/AizelNetwork/evmos/releases/tag/v2.0.0) - 2022-03-06
...
- (deps) [#360](https://github.com/AizelNetwork/evmos/pull/360) Bump Ethermint to [`v0.11.0`](https://github.com/evmos/ethermint/releases/tag/v0.11.0).
...
- (deps) [#345](https://github.com/AizelNetwork/evmos/pull/345) Bump Ethermint to [`v0.10.2`](https://github.com/evmos/ethermint/releases/tag/v0.10.2).
...
## [v1.0.0](https://github.com/AizelNetwork/evmos/releases/tag/v1.0.0) - 2022-02-28
...
## [v0.4.2](https://github.com/AizelNetwork/evmos/releases/tag/v0.4.2) - 2021-12-11
...
- (deps) [#135](https://github.com/AizelNetwork/evmos/pull/135) Bump Ethermint version to [`v0.9.0`](https://github.com/evmos/ethermint/releases/tag/v0.9.0).
- (ci) [#136](https://github.com/AizelNetwork/evmos/pull/136) Deploy `evmos` docker container to [docker hub](https://hub.docker.com/u/tharsishq) for every versioned releases.
...
- (deps) [#110](https://github.com/AizelNetwork/evmos/pull/110) Bump Ethermint version to [`v0.8.1`](https://github.com/evmos/ethermint/releases/tag/v0.8.1).
...
- (deps) [#94](https://github.com/AizelNetwork/evmos/pull/94) Bump Ethermint version to [`v0.8.0`](https://github.com/evmos/ethermint/releases/tag/v0.8.0).
...
- (build) [#30](https://github.com/AizelNetwork/evmos/pull/30) Fix `version` command.
