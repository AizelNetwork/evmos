...
aizeld add-genesis-account %KEY% 100000000000000000000000000aevmos --keyring-backend %KEYRING%

rem Sign genesis transaction
aizeld gentx %KEY% 1000000000000000000000aevmos --keyring-backend %KEYRING% --chain-id %CHAINID%
...
aizeld start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aevmos