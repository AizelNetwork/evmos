...
func CreateEthTx(
	...
	baseFeeRes, err := appAizel.EvmKeeper.BaseFee(ctx, &evmtypes.QueryBaseFeeRequest{})
	if err != nil {
	...
	nonce := appAizel.EvmKeeper.GetNonce(ctx, fromAddr) + uint64(nonceIncrement) //nolint:gosec // G115
