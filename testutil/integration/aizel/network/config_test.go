...
import (
	...
	grpchandler "github.com/AizelNetwork/evmos/v20/testutil/integration/aizel/grpc"
...
func TestWithBalances(t *testing.T) {
	key1Balance := sdk.NewCoins(sdk.NewInt64Coin(aizeltypes.BaseDenom, 1e18))
	key2Balance := sdk.NewCoins(
		sdk.NewInt64Coin(aizeltypes.BaseDenom, 2e18),
