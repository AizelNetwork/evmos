...
type genSetupFn func(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Aizel, genesisState aizeltypes.GenesisState, _ interface{}) (aizeltypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = aizelApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
// createAizelApp creates an aizel app
func createAizelApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.Aizel {
	// Create aizel app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, overwriteParams StakingCustomGenesisState) aizeltypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, overwriteParams BankCustomGenesisState) aizeltypes.GenesisState {
	...
	updatedBankGen := updateBankGenesisStateForChainID(aizelApp.ChainID(), *bankGenesis)
	genesisState[banktypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(&updatedBankGen)
	return genesisState
}
...
func setDefaultSlashingGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, overwriteParams SlashingCustomGenesisState) aizeltypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
	...
	aizelApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, genAccs []authtypes.GenesisAccount) aizeltypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
	...
	aizelApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, overwriteParams GovCustomGenesisState) aizeltypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}
...
func setDefaultFeeMarketGenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) aizeltypes.GenesisState {
	fmGen := feemarkettypes.DefaultGenesisState()
	fmGen.Params.BaseFee = overwriteParams.baseFee
	genesisState[feemarkettypes.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(fmGen)
	return genesisState
}

func setDefaultErc20GenesisState(aizelApp *app.Aizel, genesisState aizeltypes.GenesisState) aizeltypes.GenesisState {
	erc20Gen := erc20types.DefaultGenesisState()
	updatedErc20Gen := updateErc20GenesisStateForChainID(aizelApp.ChainID(), *erc20Gen)
	genesisState[erc20types.ModuleName] = aizelApp.AppCodec().MustMarshalJSON(&updatedErc20Gen)
	return genesisState
}

// defaultAuthGenesisState sets the default genesis state
// for the testing setup
func newDefaultGenesisState(aizelApp *app.Aizel, params defaultGenesisParams) aizeltypes.GenesisState {
	genesisState := aizelApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(aizelApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(aizelApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(aizelApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(aizelApp, genesisState, params.gov)
	genesisState = setDefaultSlashingGenesisState(aizelApp, genesisState, params.slashing)
	genesisState = setDefaultFeeMarketGenesisState(aizelApp, genesisState, params.feeMarket)
	genesisState = setDefaultErc20GenesisState(aizelApp, genesisState)
...
func customizeGenesis(aizelApp *app.Aizel, customGen CustomGenesisState, genesisState aizeltypes.GenesisState) (aizeltypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(aizelApp, genesisState, modGenState)
			if err != nil {
