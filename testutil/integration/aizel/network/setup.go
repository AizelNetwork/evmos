...
type genSetupFn func(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Evmos, genesisState aizeltypes.GenesisState, _ interface{}) (aizeltypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
...
// createEvmosApp creates an aizel app
...
func setDefaultStakingGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, overwriteParams StakingCustomGenesisState) aizeltypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, overwriteParams BankCustomGenesisState) aizeltypes.GenesisState {
...
func setDefaultSlashingGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, overwriteParams SlashingCustomGenesisState) aizeltypes.GenesisState {
...
func setBankGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, genAccs []authtypes.GenesisAccount) aizeltypes.GenesisState {
...
func setAuthGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, customGenesis interface{}) (aizeltypes.GenesisState, error) {
...
func setDefaultGovGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, overwriteParams GovCustomGenesisState) aizeltypes.GenesisState {
...
func setDefaultFeeMarketGenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) aizeltypes.GenesisState {
...
func setDefaultErc20GenesisState(aizelApp *app.Evmos, genesisState aizeltypes.GenesisState) aizeltypes.GenesisState {
...
func newDefaultGenesisState(aizelApp *app.Evmos, params defaultGenesisParams) aizeltypes.GenesisState {
...
func customizeGenesis(aizelApp *app.Evmos, customGen CustomGenesisState, genesisState aizeltypes.GenesisState) (aizeltypes.GenesisState, error) {
	var err error
