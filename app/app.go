...
func init() {
	...
	// manually update the power reduction by replacing micro (u) -> atto (a) aizel
	sdk.DefaultPowerReduction = aizeltypes.PowerReduction
...
var (
	_ servertypes.Application = (*Aizel)(nil)
	_ ibctesting.TestingApp   = (*Aizel)(nil)
	_ runtime.AppI            = (*Aizel)(nil)
)

// Aizel implements an extended ABCI application. It is an application
...
func (*Aizel) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewAizel returns a reference to a new initialized Ethermint application.
func NewAizel(
	logger log.Logger,
	db dbm.DB,
	...
	aizelAppOptions AizelOptionsFn,
	...
	if err := aizelAppOptions(bApp.ChainID()); err != nil {
		panic(err)
	}
...
func (app *Aizel) Name() string { return app.BaseApp.Name() }

func (app *Aizel) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: aizeltypes.HasDynamicFeeExtensionOption,
...
func (app *Aizel) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Aizel) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.mm.EndBlock(ctx)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Aizel) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	defer func() {
...
func (app *Aizel) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState aizeltypes.GenesisState
...
func (app *Aizel) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// LoadHeight loads state at a particular height
func (app *Aizel) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Aizel) ModuleAccountAddrs() map[string]bool {
...
func (app *Aizel) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Aizel's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Aizel) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Aizel's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Aizel) AppCodec() codec.Codec {
	return app.appCodec
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *Aizel) DefaultGenesis() aizeltypes.GenesisState {
	return app.BasicModuleManager.DefaultGenesis(app.appCodec)
}

// InterfaceRegistry returns Aizel's InterfaceRegistry
func (app *Aizel) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Aizel) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Aizel) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Aizel) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Aizel) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Aizel) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Aizel) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Aizel) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Aizel) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Aizel) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Aizel) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Aizel) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Aizel) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Aizel) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Aizel) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Aizel) AutoCliOpts() autocli.AppOptions {
...
func (app *Aizel) setupUpgradeHandlers() {
	// v20 upgrade handler
